...
export default function ToolItem01({ title, subtitle, description, buttonText, imageSrc }) {
  return (
    <div className="main-grid grid grid-cols-5 items-start py-20 border-t border-black mt-16 gap-8">
      <div className="col-span-3">
        ...
        <button className="bg-black text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider">
          {buttonText}
        </button>
      </div>
