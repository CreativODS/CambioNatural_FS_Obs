...
<div className="overflow-hidden bg-[#17BA4F] text-black">
  ...
  {/* SECCIÓN 1: Cuerpo01 */}
  <section className="main-grid pt-32 pb-16">
  ...
  {/* SECCIÓN 2: Article */}
  <section className="main-grid pt-20 pb-20">
  ...
  <section className="main-grid pt-36 pb-20">
  ...
  {/* NEWSLETTER */}
  <section className="main-grid pt-52 pb-36">
